...
class ChatCompletionCreateParamsNonStreaming(TypedDict):
    ...
    top_logprobs: float | Any  # An integer between 0 and 20 specifying the number of most likely tokens to return at each token position, each with an associated log probability.   must be set to   if this parameter is used.
