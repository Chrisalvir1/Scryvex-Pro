...
export interface Camera {
    ...
    mac_address?: string; onvif_uuid?: string; last_known_ip?: string; network_interface?: string; identity_status?: CameraStatus;
}
...
export class CameraService {
    ...
    async migrate(): Promise<void> {
        ...
        await this.pool.query(`ALTER TABLE scryvex_core.cameras ADD COLUMN IF NOT EXISTS mac_address TEXT, ADD COLUMN IF NOT EXISTS onvif_uuid TEXT, ADD COLUMN IF NOT EXISTS last_known_ip INET, ADD COLUMN IF NOT EXISTS network_interface TEXT, ADD COLUMN IF NOT EXISTS identity_status TEXT NOT NULL DEFAULT 'unknown'`);
